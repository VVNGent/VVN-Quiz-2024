...
While the matrix defined above is unconditionally stable, with periodic boundary conditions, the implementation of equation \ref{MatrixEquation} is unstable.
